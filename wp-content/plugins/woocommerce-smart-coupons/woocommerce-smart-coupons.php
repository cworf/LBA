				...
				if (Smart_Coupons_WC_Compatibility::global_wc()->cart->applied_coupons) {
					...
					foreach (Smart_Coupons_WC_Compatibility::global_wc()->cart->applied_coupons as $code) {
						...
						if ( $smart_coupon->is_valid() && $smart_coupon->type=='smart_coupon' ) {
							...
							if (empty(Smart_Coupons_WC_Compatibility::global_wc()->cart->coupon_discount_amounts)) {
								Smart_Coupons_WC_Compatibility::global_wc()->cart->coupon_discount_amounts = array();
							}
							Smart_Coupons_WC_Compatibility::global_wc()->cart->coupon_discount_amounts[$code]     = $smart_coupon->amount;
						}
					}
				}
			}
