...
<script type="text/javascript">
	window.woocommerce_wishlist_add_to_wishlist_url = "<?php echo add_query_arg(array('add-to-wishlist-itemid' => $product->id), $product->add_to_cart_url()); ?>";
</script>
<?php else : ?>
<script type="text/javascript">
	window.woocommerce_wishlist_add_to_wishlist_url = "<?php echo add_query_arg(array('add-to-wishlist-itemid' => $product->id) ); ?>";
</script>
<?php endif; ?>
